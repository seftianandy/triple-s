    ...
    <div class="az-header">
      <div class="container">
        <div class="az-header-left">
          <a href="index.html" class="az-logo"><span></span> triple-s</a>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <nav class="az-menu-sub">
                <a href="" class="nav-link">Atlit</a>
                <a href="" class="nav-link">Juri</a>
                <a href="" class="nav-link">Scores</a>
                <a href="" class="nav-link">Admin Users</a>
              </nav>
            </li>
            <li class="nav-item">
              <a href="chart-chartjs.html" class="nav-link"><i class="typcn typcn-group-outline"></i> Match List</a>
            </li>
            <li class="nav-item">
              <a href="form-elements.html" class="nav-link"><i class="typcn typcn-time"></i> Activity Logs</a>
            </li>
          </ul>
        </div><!-- az-header-menu -->
        <div class="az-header-right">
          ...
          <div class="dropdown az-profile-menu">
            <a href="" class="az-img-user"><img src="{{ asset('azia') }}/img/faces/user.png" alt=""></a>
            <div class="dropdown-menu">
              ...
              <div class="az-header-profile">
                <div class="az-img-user">
                  <img src="{{ asset('azia') }}/img/faces/user.png" alt="">
                </div><!-- az-img-user -->
                <h6>Dewan Juri</h6>
                <span>Akun Penilai</span>
